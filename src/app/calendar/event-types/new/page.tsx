  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        addToast(data.error || 'Failed to create event type', 'error');
      }
    } catch {
  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">New Event Type</h1>
          <p className="text-gray-400 text-sm">Create a new type of meeting people can book</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={e => updateField('min_notice', parseInt(e.target.value) || 0)}
                min={0}
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300 focus:outline-none focus:border-blue-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={e => updateField('max_days_ahead', parseInt(e.target.value) || 30)}
                min={1}
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300 focus:outline-none focus:border-blue-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={e => updateField('max_per_day', parseInt(e.target.value) || 0)}
                min={0}
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300 focus:outline-none focus:border-blue-500"
              />
            </div>
        ...
        <Section title="AI Agenda" icon={Brain}>
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              type="checkbox"
              checked={form.ai_agenda_enabled}
              onChange={e => updateField('ai_agenda_enabled', e.target.checked)}
